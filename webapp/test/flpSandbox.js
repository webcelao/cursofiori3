					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App de conclusão de Curso FIORI - Marcelo Fermino de Almeida",
									"targetURL": "#zmfaapptcc-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zmfaapptcc-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmfaapptcc",
									"url": sap.ui.require.toUrl("zmfaapptcc")
								}
							}
						}
					}
